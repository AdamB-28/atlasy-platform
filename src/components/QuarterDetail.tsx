...
function MetricCard({ label, value, unit }: MetricCardProps) {
  if (!hasData(value)) {
    return (
      <div className="p-4 bg-neutral-50 dark:bg-neutral-800 rounded-lg border border-neutral-200 dark:border-neutral-700 transition-colors duration-500">
        <p className="metric-label">{label}</p>
        <p className="text-sm text-neutral-400 dark:text-neutral-500 mt-2">No data available</p>
      </div>
    )
  }
  
  return (
    <div className="p-4 bg-white dark:bg-neutral-800 rounded-lg border border-neutral-200 dark:border-neutral-700 transition-colors duration-500">
      <p className="metric-label">{label}</p>
      <p className="metric-value">
        {formatMetricValue(value)}
        {unit && <span className="text-base text-neutral-500 dark:text-neutral-400 ml-1">{unit}</span>}
      </p>
    </div>
  )
}
...
export default function QuarterDetail({ quarter, cityName }: QuarterDetailProps) {
  ...
  return (
    <div className="space-y-8">
      {/* Quarter Header */}
      <div>
        <h3 className="text-2xl font-bold text-neutral-900 dark:text-white mb-2 transition-colors duration-500">{quarter.name}</h3>
        {hasData(quarter.function) && (
          <p className="text-neutral-600 dark:text-neutral-400 transition-colors duration-500">{quarter.function}</p>
        )}
      </div>
      ...
      {(hasData(quarter.plan) || hasData(quarter.form3d)) && (
        <div className="grid md:grid-cols-2 gap-6">
          {hasData(quarter.plan) && (
            <div className="card">
              <h4 className="section-title">Site Plan</h4>
              <SafeImage
          ...
          {hasData(quarter.form3d) && (
            <div className="card">
              <h4 className="section-title">3D Form</h4>
              <SafeImage
      ...
      {/* Urban Indicators */}
      <div className="card">
        <h4 className="section-title">Urban Indicators</h4>
      ...
      {hasData(quarter.sunHours) && (
        <div className="card">
          <h4 className="section-title">Sun Hours Analysis</h4>
          <SafeImage
      ...
      {(hasData(quarter.daylightPotential) || hasData(quarter.daylightPotential2)) && (
        <div className="card">
          <h4 className="section-title">Daylight Potential</h4>
          <div className="grid md:grid-cols-2 gap-6">
      ...
      {hasData(quarter.solarEnergy) && (
        <div className="card">
          <h4 className="section-title">Solar Energy Analysis</h4>
          <SafeImage
      ...
      {quarter.daylightFactor && (
        <div className="card">
          <h4 className="section-title">Daylight Factor (DF) Analysis</h4>
          <p className="text-sm text-neutral-600 dark:text-neutral-400 mb-6 transition-colors duration-500">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            {hasData(quarter.daylightFactor.simulation1?.image) && (
              <div className="space-y-3">
                <h5 className="font-semibold text-neutral-900 dark:text-white transition-colors duration-500">Worst Case Scenario</h5>
                <SafeImage
                ...
                {hasData(quarter.daylightFactor.simulation1.description) && (
                  <p className="text-sm text-neutral-600 dark:text-neutral-400 p-4 bg-neutral-50 dark:bg-neutral-800 rounded-lg transition-colors duration-500">
            ...
            {hasData(quarter.daylightFactor.simulation2?.image) && (
              <div className="space-y-3">
                <h5 className="font-semibold text-neutral-900 dark:text-white transition-colors duration-500">Best Case Scenario</h5>
                <SafeImage
      ...
      {quarter.spatialDaylightAutonomy && (
        <div className="card">
          <h4 className="section-title">Spatial Daylight Autonomy (sDA)</h4>
          <p className="text-sm text-neutral-600 dark:text-neutral-400 mb-6 transition-colors duration-500">
          ...
          {hasData(quarter.spatialDaylightAutonomy.interpretation) && (
            <div className="mt-6 p-4 bg-primary-50 dark:bg-primary-900/20 border border-primary-100 dark:border-primary-800 rounded-lg transition-colors duration-500">
              <h5 className="font-semibold text-neutral-900 dark:text-white mb-2 transition-colors duration-500">Interpretation</h5>
      ...
      {quarter.usefulDaylightIlluminance && (
        <div className="card">
          <h4 className="section-title">Useful Daylight Illuminance (UDI)</h4>
          <p className="text-sm text-neutral-600 dark:text-neutral-400 mb-6 transition-colors duration-500">
          ...
          {hasData(quarter.usefulDaylightIlluminance.conclusions) && (
            <div className="mt-4 p-4 bg-neutral-50 dark:bg-neutral-800 border border-neutral-200 dark:border-neutral-700 rounded-lg transition-colors duration-500">
              <h5 className="font-semibold text-neutral-900 dark:text-white mb-2 transition-colors duration-500">Conclusions</h5>
              <p className="text-sm text-neutral-700 dark:text-neutral-300 transition-colors duration-500">
