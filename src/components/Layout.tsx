...
export default function Layout({ children }: LayoutProps) {
  ...
  return (
    <div className={`min-h-screen flex flex-col ${darkMode ? 'bg-neutral-900' : 'bg-neutral-50'} transition-colors duration-500`}>
        ...
        <div className="container mx-auto px-4 sm:px-6 py-3 sm:py-4">
          <div className="flex items-center justify-between">
            <Link to="/" className="flex items-center gap-2 sm:gap-3 hover:opacity-80 transition-opacity">
              <Building2 className={`w-6 h-6 sm:w-8 sm:h-8 ${darkMode ? 'text-primary-400' : 'text-primary-600'} transition-colors duration-500`} />
              <div>
                <h1 className={`text-base sm:text-xl font-bold ${darkMode ? 'text-white' : 'text-neutral-900'} transition-colors duration-500`}>
                  Atlases: IEA Task 70
                </h1>
                <p className={`text-xs ${darkMode ? 'text-neutral-400' : 'text-neutral-500'} hidden sm:block transition-colors duration-500`}>
            ...
            <nav className="flex items-center gap-4 sm:gap-6">
              <Link 
                to="/" 
                className={`flex items-center gap-2 text-sm font-medium ${darkMode ? 'text-neutral-300 hover:text-primary-400' : 'text-neutral-600 hover:text-primary-600'} transition-colors`}
              >
              ...
              <button
                ...
                className="relative w-14 h-14 rounded-full overflow-hidden group shadow-lg"
              ...
              >
                <div className={`absolute inset-0 transition-all duration-1000 ease-in-out ${
                  ...
                  <div 
                    className={`absolute w-6 h-6 rounded-full transition-all duration-1000 ease-in-out ${
                      darkMode 
      ...
      <footer className={`${darkMode ? 'bg-black border-neutral-700' : 'bg-neutral-900 border-neutral-800'} text-white border-t mt-12 transition-colors duration-500`}>
        <div className="container mx-auto px-4 sm:px-6 py-8 sm:py-12">
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            <div>
              <h3 className="font-semibold mb-3">About This Platform</h3>
            ...
            <div>
              ...
              <div className="text-sm text-neutral-300 leading-relaxed space-y-2">
                <p>
                  ...
                  <span className="text-neutral-400 text-xs">Head of Department</span>
                </p>
                <p>
