    ...
    <Layout>
      ...
      <section className="bg-gradient-to-br from-primary-50 to-neutral-50 dark:from-neutral-800 dark:to-black border-b border-neutral-200 dark:border-neutral-700 transition-colors duration-500">
        <div className="container mx-auto px-4 sm:px-6 py-12 sm:py-16">
          <div>
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-neutral-900 dark:text-white mb-4 sm:mb-6 transition-colors duration-500">
              Understanding Urban Daylight & Energy Performance
            </h1>
            <p className="text-base sm:text-lg text-neutral-600 dark:text-neutral-300 mb-6 sm:mb-8 leading-relaxed transition-colors duration-500">
            ...
            <div className="bg-white dark:bg-neutral-800 rounded-lg border-2 border-primary-200 dark:border-primary-700 p-6 mb-6 transition-colors duration-500">
              <h2 className="text-xl font-bold text-neutral-900 dark:text-white mb-4 flex items-center gap-2 transition-colors duration-500">
                <span className="text-2xl">📖</span>
                How to Use This Platform
              </h2>
              <ol className="space-y-3 text-neutral-700 dark:text-neutral-300 transition-colors duration-500">
            ...
            <div className="grid sm:grid-cols-3 gap-4 sm:gap-6 mt-8 sm:mt-12">
              <div className="flex items-start gap-3 p-4 bg-white dark:bg-neutral-800 rounded-lg border border-neutral-200 dark:border-neutral-700 transition-colors duration-500">
                ...
                <div>
                  <h3 className="font-semibold text-neutral-900 dark:text-white text-sm sm:text-base">Daylight Analysis</h3>
                  <p className="text-xs sm:text-sm text-neutral-600 dark:text-neutral-400 mt-1 transition-colors duration-500">
              ...
              <div className="flex items-start gap-3 p-4 bg-white dark:bg-neutral-800 rounded-lg border border-neutral-200 dark:border-neutral-700 transition-colors duration-500">
                ...
                <div>
                  <h3 className="font-semibold text-neutral-900 dark:text-white text-sm sm:text-base">Urban Morphology</h3>
                  <p className="text-xs sm:text-sm text-neutral-600 dark:text-neutral-400 mt-1 transition-colors duration-500">
              ...
              <div className="flex items-start gap-3 p-4 bg-white dark:bg-neutral-800 rounded-lg border border-neutral-200 dark:border-neutral-700 transition-colors duration-500">
                ...
                <div>
                  <h3 className="font-semibold text-neutral-900 dark:text-white text-sm sm:text-base">Energy Performance</h3>
                  <p className="text-xs sm:text-sm text-neutral-600 dark:text-neutral-400 mt-1 transition-colors duration-500">
      ...
      {/* IEA Mission Context */}
      <section className="bg-white dark:bg-neutral-900 border-b border-neutral-200 dark:border-neutral-700 py-12 transition-colors duration-500">
        <div className="container mx-auto px-6">
          <div>
            <div className="flex items-start gap-4 p-6 bg-primary-50 dark:bg-primary-900/20 rounded-lg border border-primary-100 dark:border-primary-800 transition-colors duration-500">
              <Info className="w-6 h-6 text-primary-600 flex-shrink-0 mt-1" />
              <div>
                <h3 className="font-semibold text-neutral-900 dark:text-white mb-2">Educational Context</h3>
      ...
      <section className="py-8 sm:py-12">
        <div className="container mx-auto px-4 sm:px-6">
          <h2 className="text-2xl sm:text-3xl font-bold text-neutral-900 dark:text-white mb-4 sm:mb-8 transition-colors duration-500">Explore Cities</h2>
          
          <div className="grid lg:grid-cols-[380px_1fr] gap-6 sm:gap-8 items-start">
            {/* Sidebar - City List */}
            <aside className="space-y-4">
              <div className="lg:sticky lg:top-24">
                <h3 className="text-sm font-semibold text-neutral-500 dark:text-neutral-400 uppercase tracking-wide mb-4 transition-colors duration-500">
                  📍 Locations Studied ({cities.length})
                </h3>
                <p className="text-sm text-neutral-600 dark:text-neutral-400 mb-4 lg:hidden transition-colors duration-500">
                ...
                {selectedCity && (
                  <div className="mt-6 p-6 bg-gradient-to-br from-primary-50 to-primary-100 dark:from-primary-900/30 dark:to-primary-800/30 border-2 border-primary-300 dark:border-primary-700 rounded-lg shadow-md transition-colors duration-500">
                    <div className="flex items-center gap-2 mb-2">
                      <div className="w-2 h-2 rounded-full bg-primary-600 dark:bg-primary-400 animate-pulse"></div>
                      <p className="text-sm font-semibold text-primary-900 dark:text-primary-100 uppercase tracking-wide transition-colors duration-500">
                        Selected City
                      </p>
                    </div>
                    <p className="text-lg font-bold text-neutral-900 dark:text-white mb-2 transition-colors duration-500">
                      {selectedCity.name}
                    </p>
            ...
            <div className="space-y-4">
              <div className="h-[400px] sm:h-[500px] lg:h-[600px] bg-white dark:bg-neutral-800 rounded-lg border border-neutral-200 dark:border-neutral-700 overflow-hidden shadow-sm transition-colors duration-500">
                <InteractiveMap
                  cities={cities}
              ...
              {selectedCity && (
                <button
                  ...
                  className="w-full btn-primary text-base py-4 shadow-lg hover:shadow-xl transform hover:scale-[1.02] transition-all"
                >
      ...
      {/* Educational Note */}
      <section className="bg-neutral-100 dark:bg-black py-12 transition-colors duration-500">
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto text-center">
            <h3 className="text-2xl font-bold text-neutral-900 dark:text-white mb-4 transition-colors duration-500">
              Why Study Urban Daylight?
            </h3>
            <p className="text-neutral-700 dark:text-neutral-300 leading-relaxed mb-6 transition-colors duration-500">
            ...
            <p className="text-sm text-neutral-600 dark:text-neutral-400 transition-colors duration-500">
