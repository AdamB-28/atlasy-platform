    ...
    <Layout>
        ...
        <div className="container mx-auto px-4 sm:px-6 py-4 sm:py-6">
          ...
          <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
            <div className="flex-1">
              ...
              <h1 className="text-3xl sm:text-4xl font-bold text-neutral-900 dark:text-white mb-3 transition-colors duration-500">{city.name}</h1>
              {city.location.country && (
                <div className="flex items-center gap-2 text-neutral-600 dark:text-neutral-400 transition-colors duration-500">
                  <MapPin className="w-4 h-4" />
                  <span>{city.location.country}</span>
                </div>
              )}
              <div className="mt-4 p-3 bg-primary-50 dark:bg-primary-900/20 border-l-4 border-primary-500 rounded transition-colors duration-500">
            ...
            {otherCities.length > 0 && (
              <div className="sm:relative group w-full sm:w-auto">
                <button className="btn-primary flex items-center justify-center gap-2 w-full sm:w-auto">
                  <GitCompare className="w-4 h-4" />
                  <span>Compare with Another City</span>
                </button>
                
                <div className="sm:absolute right-0 top-full mt-2 w-full sm:w-80 bg-white dark:bg-neutral-800 rounded-lg shadow-xl border border-neutral-200 dark:border-neutral-700 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-10">
                  <div className="p-3">
                    <p className="text-xs text-neutral-500 dark:text-neutral-400 uppercase tracking-wide font-semibold mb-2 px-2 transition-colors duration-500">
                    ...
                    {otherCities.map((otherCity) => (
                      <button
                        ...
                        className="w-full text-left px-4 py-3 rounded-md hover:bg-primary-50 dark:hover:bg-primary-900/20 transition-colors flex items-center justify-between group/item"
                      >
                        <div>
                          <div className="font-medium text-neutral-900 dark:text-white group-hover/item:text-primary-600 dark:group-hover/item:text-primary-400 transition-colors duration-500">
                            {otherCity.name}
                          </div>
                          <div className="text-sm text-neutral-500 dark:text-neutral-400">{otherCity.location.country}</div>
                        </div>
                        <ChevronRight className="w-4 h-4 text-neutral-400 dark:text-neutral-500 group-hover/item:text-primary-600 dark:group-hover/item:text-primary-400" />
                      </button>
                    ))}
                  </div>
                </div>
      ...
      <div className="container mx-auto px-4 sm:px-6 py-8 sm:py-12">
            ...
            {hasData(city.timeline.years) && (
              <div className="card">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="section-title mb-0">Timeline</h3>
                </div>
                <p className="text-2xl font-semibold text-neutral-900 dark:text-white mb-3 transition-colors duration-500">{city.timeline.years}</p>
                {hasData(city.timeline.description) && (
                  <p className="text-sm text-neutral-600 dark:text-neutral-400 leading-relaxed transition-colors duration-500">{city.timeline.description}</p>
                )}
              </div>
            )}
        ...
        {(hasData(city.overview.schwarzplanImage) || hasData(city.overview.model3dImage)) && (
          <div className="mb-12">
            <h2 className="text-2xl font-bold text-neutral-900 dark:text-white mb-6 transition-colors duration-500">Urban Analysis</h2>
            <div className="grid md:grid-cols-2 gap-6">
              {hasData(city.overview.schwarzplanImage) && (
                <div className="card">
                  <h3 className="section-title">Schwarzplan</h3>
                  <p className="text-sm text-neutral-600 dark:text-neutral-400 mb-4 transition-colors duration-500">
              ...
              {hasData(city.overview.model3dImage) && (
                <div className="card">
                  <h3 className="section-title">3D Model</h3>
                  <p className="text-sm text-neutral-600 dark:text-neutral-400 mb-4 transition-colors duration-500">
        ...
        {/* Urban Indicators */}
        <div className="mb-12">
          <h2 className="text-2xl font-bold text-neutral-900 dark:text-white mb-6 transition-colors duration-500">Urban Indicators</h2>
            ...
            {hasData(city.urbanIndicators.buildingIntensity) && (
              <div className="card">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <h3 className="font-semibold text-neutral-900 dark:text-white transition-colors duration-500">Building Intensity</h3>
                </div>
                <p className="text-2xl font-bold text-neutral-900 dark:text-white transition-colors duration-500">
                  {city.urbanIndicators.buildingIntensity}
                </p>
                {hasData(city.urbanIndicators.buildingTypes) && (
                  <p className="text-sm text-neutral-600 dark:text-neutral-400 mt-3 leading-relaxed transition-colors duration-500">
            ...
            {hasData(city.urbanIndicators.greenSpacePercentage) && (
              <div className="card">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <h3 className="font-semibold text-neutral-900 dark:text-white transition-colors duration-500">Green Space</h3>
                </div>
                <p className="text-2xl font-bold text-neutral-900 dark:text-white transition-colors duration-500">
            ...
            {hasData(city.urbanIndicators.transport) && (
              <div className="card">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <h3 className="font-semibold text-neutral-900 dark:text-white transition-colors duration-500">Transport</h3>
                </div>
          ...
          <div className="mt-6">
            ...
            >
              ...
              {showUrbanInsights ? <ChevronUp className="w-4 h-4 text-primary-600 dark:text-primary-400" /> : <ChevronDown className="w-4 h-4 text-primary-600 dark:text-primary-400" />}
            </button>
            ...
            {showUrbanInsights && (
              <div className="mt-3 p-4 bg-white dark:bg-neutral-800 rounded-lg border border-primary-200 dark:border-primary-700 shadow-sm space-y-3 animate-in fade-in slide-in-from-top-2 duration-300 transition-colors">
                <div>
                  <h4 className="font-semibold text-neutral-900 dark:text-white mb-1 transition-colors duration-500">Building Intensity</h4>
                  <p className="text-sm text-neutral-700 dark:text-neutral-300 leading-relaxed transition-colors duration-500">
                ...
                <div>
                  <h4 className="font-semibold text-neutral-900 dark:text-white mb-1 transition-colors duration-500">Green Space Percentage</h4>
                  <p className="text-sm text-neutral-700 dark:text-neutral-300 leading-relaxed transition-colors duration-500">
                ...
                <div>
                  <h4 className="font-semibold text-neutral-900 dark:text-white mb-1 transition-colors duration-500">Building Coverage</h4>
                  <p className="text-sm text-neutral-700 dark:text-neutral-300 leading-relaxed transition-colors duration-500">
        ...
        {(hasData(city.shadingAnalysis.marchSeptember) || 
          ...
          <div className="mb-12">
            <h2 className="text-2xl font-bold text-neutral-900 dark:text-white mb-6 transition-colors duration-500">Seasonal Shading Analysis</h2>
            <div className="grid md:grid-cols-3 gap-6">
              {hasData(city.shadingAnalysis.marchSeptember) && (
                <div className="card">
                  <h3 className="section-title">March & September</h3>
                  <p className="text-sm text-neutral-600 dark:text-neutral-400 mb-4 transition-colors duration-500">Equinox conditions</p>
                  <SafeImage
              ...
              {hasData(city.shadingAnalysis.june) && (
                <div className="card">
                  <h3 className="section-title">June</h3>
                  <p className="text-sm text-neutral-600 dark:text-neutral-400 mb-4 transition-colors duration-500">Summer solstice</p>
                  <SafeImage
              ...
              {hasData(city.shadingAnalysis.december) && (
                <div className="card">
                  <h3 className="section-title">December</h3>
                  <p className="text-sm text-neutral-600 dark:text-neutral-400 mb-4 transition-colors duration-500">Winter solstice</p>
                  <SafeImage
            ...
            <div className="mt-6">
              ...
              >
                ...
                {showShadingInsights ? <ChevronUp className="w-4 h-4 text-primary-600 dark:text-primary-400" /> : <ChevronDown className="w-4 h-4 text-primary-600 dark:text-primary-400" />}
              </button>
              
              {showShadingInsights && (
                <div className="mt-3 p-4 bg-white dark:bg-neutral-800 rounded-lg border border-primary-200 dark:border-primary-700 shadow-sm space-y-3 animate-in fade-in slide-in-from-top-2 duration-300 transition-colors">
                  <div>
                    <h4 className="font-semibold text-neutral-900 dark:text-white mb-1 transition-colors duration-500">Why Study Seasonal Shading?</h4>
                    <p className="text-sm text-neutral-700 dark:text-neutral-300 leading-relaxed transition-colors duration-500">
                  ...
                  <div>
                    <h4 className="font-semibold text-neutral-900 dark:text-white mb-1 transition-colors duration-500">Equinox (March/September)</h4>
                    <p className="text-sm text-neutral-700 dark:text-neutral-300 leading-relaxed transition-colors duration-500">
                  ...
                  <div>
                    <h4 className="font-semibold text-neutral-900 dark:text-white mb-1 transition-colors duration-500">Summer Solstice (June)</h4>
                    <p className="text-sm text-neutral-700 dark:text-neutral-300 leading-relaxed transition-colors duration-500">
                  ...
                  <div>
                    <h4 className="font-semibold text-neutral-900 dark:text-white mb-1 transition-colors duration-500">Winter Solstice (December)</h4>
                    <p className="text-sm text-neutral-700 dark:text-neutral-300 leading-relaxed transition-colors duration-500">
        ...
        {city.quarters.length > 0 && (
          <div>
            <h2 className="text-2xl font-bold text-neutral-900 dark:text-white mb-6 transition-colors duration-500">
